...
<div class="relative h-full w-full">
    ...
    <div class="absolute left-12 top-1/2 -translate-y-1/2 text-white z-10 hidden md:block">
        ...
        <p class="mt-4 text-lg text-gray-200 max-w-md">
            Masukkan email Anda, lalu kami akan mengirim kode OTP ke email asli Anda.
        </p>
    </div>
    <div class="absolute right-10 top-1/2 -translate-y-1/2 z-10 w-full max-w-md">
        <div class="bg-white p-10 rounded-2xl shadow-lg">
            ...
            @endif
            <form method="POST" action="{{ route('otp.login') }}" class="space-y-5">
                @csrf
                <div>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Sudah punya kata sandi?
                <a href="{{ route('login') }}" class="text-blue-500 hover:underline">Masuk dengan Password</a>
            </p>
        </div>
    </div>
</div>
